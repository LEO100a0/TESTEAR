        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-blue-700">Envíanos un mensaje</h3>
                    <form onSubmit={handleSubmit}>
                        ...
                        <button 
                            type="submit" 
                            className="bg-blue-600 text-white px-6 py-3 rounded hover:bg-blue-700 font-medium w-full"
                        >
                            Enviar Mensaje
                        </button>
                    </form>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-2xl font-bold mb-4 text-blue-700">Información de contacto</h3>
                    <div className="space-y-4">
                        <div className="flex items-start">
                            <i className="fas fa-map-marker-alt text-blue-600 mt-1 mr-3"></i>
                            <div>
                                <h4 className="font-bold">Dirección</h4>
                                <p className="text-gray-600">Calle Mascotas 123, Col. Animales Felices, Ciudad de México, 12345</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">contacto@petstore.com</p>
                            </div>
                        </div>
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Lunes a Viernes: 9:00 - 20:00<br/>Sábado y Domingo: 10:00 - 18:00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Redes sociales */}
                    <div className="mt-6">
                        <h4 className="font-bold mb-3">Síguenos en redes sociales</h4>
